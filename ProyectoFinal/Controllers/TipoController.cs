...
namespace ProyectoFinal.Controllers
{
    ...
    public class TipoController : Controller
    {
        ...
        public TipoController(AutoCarDBcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //            Problem("Entity set 'AutoCarDBcontext.Tipos'  is null.");
            var marcasOrdenados = await _context.Tipos
             .OrderBy(v => v.Descripcion)  // Ordenar por fecha                      
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AutoCarDBcontext.Tipos'  is null.");
            }
            var tipo = await _context.Tipos.FindAsync(id);
            if (tipo != null)
            {
